...
#ifndef _LOGSOURCEFORMAT_H
#define _LOGSOURCEFORMAT_H

#include "LogFormat.h"

/**
 * Adds a source code location section to the log
 */
class LogSourceFormat : public LogFormat
{
    public:
        virtual ~LogSourceFormat() {};
